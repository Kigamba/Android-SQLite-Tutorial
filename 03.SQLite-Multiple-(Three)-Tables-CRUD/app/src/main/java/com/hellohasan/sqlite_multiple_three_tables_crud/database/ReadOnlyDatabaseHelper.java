...
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.STUDENT_EMAIL;
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.STUDENT_ID;
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.STUDENT_ID_FK;
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.STUDENT_NAME;
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.STUDENT_PHONE;
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.STUDENT_REGISTRATION_NUM;
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.STUDENT_SUB_CONSTRAINT;
...
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.SUBJECT_ID_FK;
...
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.TABLE_STUDENT_SUBJECT;
import static com.hellohasan.sqlite_multiple_three_tables_crud.util.Constants.TABLE_SUBJECT;

public class ReadOnlyDatabaseHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "student-db";
    private static final int DATABASE_VERSION = 1;

    private static ReadOnlyDatabaseHelper databaseHelper;

    public ReadOnlyDatabaseHelper() {
        super(MyApp.context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public static ReadOnlyDatabaseHelper getInstance() {

        if (databaseHelper == null) {
            synchronized (ReadOnlyDatabaseHelper.class){ //thread safe singleton
                if (databaseHelper == null)
                    databaseHelper = new ReadOnlyDatabaseHelper();
            }
        }
